...
|---|---|---|---|---|
| [RAD-001](tasks/phase-0-foundation/rad-001-initialize-repo-and-baseline-next-js-application.md) | Initialize repo and baseline Next.js application | P0 | Review | Create or normalize the project foundation so Radar has a clean Next.js application structure, package scripts, TypeScript config, and predictable local development workflow. |
